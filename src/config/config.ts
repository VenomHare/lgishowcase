...
const Config = {
    ...
    ModList: [
        ...
        },
        {
            ...
            description: `The WWE HCTP 2K25 Evolution Patch brings a revolutionary upgrade to the beloved WWE Here Comes The Pain, seamlessly blending modern wrestling with the classic charm of the PS2 era. This feature-rich mod introduces a fully updated 2025 roster, including superstars from RAW, SmackDown, NXT, and even legendary icons. With stunning HD arenas like WrestleMania 40 and Royal Rumble, along with realistic entrances, Titantrons, and authentic theme songs, the experience feels like a true next-gen WWE title. Players can enjoy new movesets, updated attires, enhanced commentary, and a completely revamped UI and match presentation that revitalizes the classic gameplay. Designed for smooth performance on both PCSX2 and modded PS2 consoles, the patch offers an easy installation process, making it a must-have for any wrestling game enthusiast looking to relive nostalgia with a modern twist.`,
            patchnotes: "Piracy Warning: Unauthorized distribution and sharing of this mod is strictly prohibited. Piracy not only undermines the hard work and effort that went into creating this content but also violates copyright laws. Respect the developers—only purchase this mod through official channels. Thank you for supporting fair practices!",
            Price: {
                id: "usd",
                name: "USD",
