        ...
        <div className='privacyParent'>
            <>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Patch Work.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Patch Work, accessible from <a href="https://lgimodz.vercel.app/" rel="external nofollow noopener" target="_blank">https://lgimodz.vercel.app/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: urdbest07@gmail.com</li>
                </ul>
            </>
        </div>
            <Footer />
